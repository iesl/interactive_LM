...
LDA_MODEL_PATH='/iesl/canvas/hschang/language_modeling/interactive_LM/models/LDA/LDA_wiki2016_150' #optional
WORD_CLUSTER_PATH='/iesl/canvas/hschang/language_modeling/interactive_LM/models/GloVe_clustering/normalized_center_emb_n1000' #optional
...
if [ $AUTO_EVAL_TOPICS == "Y" ]; then
	OUT_FILE="$OUPUT_FILE_DIR/topics_wiki2016"
...
if [ $OUTPUT_CSV_FOR_MTURK == "Y" ]; then
	STS_FILE='/iesl/canvas/hschang/language_modeling/NSD_for_sentence_embedding/dataset_testing/STS/stsbenchmark/sts-train_longer_uniq.csv'
